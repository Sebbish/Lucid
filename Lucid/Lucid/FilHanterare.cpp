...
FilHanterare::FilHanterare(void)
{
	...
	mTexture[49]->loadFromFile(path+"LucidProject/Resources/Graphics/Animations/Misc/StairwayUp.png",sf::IntRect(0,0,312,244));
	mTexture[50]->loadFromFile(path+"LucidProject/Resources/Graphics/Animations/Misc/StairwayDown.png",sf::IntRect(0,0,312,244));
